...
public class Messages
{
    ...
    public const string EnterSearchPhrase = "Wpisz tekst, którego chcesz szukać:";
    public const string EnterBeforeLines = "Ile linii przed wynikiem pokazać:";
    public const string EnterAfterLines = "Ile linii po wyniku pokazać:";
    public const string OperationStarted = "Trwa operacja...";
    ...
    public const string RunningCommand = "Uruchamiam:";
    public const string UnsupportedFormat = "Format nieobsługiwany.";
    public const string FixFormatQuestion = "Czy poprawić format? (T/N)";
