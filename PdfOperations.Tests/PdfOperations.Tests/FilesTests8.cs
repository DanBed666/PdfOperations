...
{
    [TestMethod]
    public static void PrepareTempDirTest()
    {
        string tempDir = Files8.PrepareTempDir();
    }
    
    [TestMethod]
    public static void PrepareTempPathTest()
    {
    ...
    [TestMethod]
    public static void PrepareTempPathWithoutExtTest()
    {
        OperationInput operationInput = new OperationInput()
        {
            Output = "lipa.pdf"
    ...
    [TestMethod]
    public static void PrepareFinalPathTest()
    {
        OperationInput operationInput = new OperationInput()
        {
